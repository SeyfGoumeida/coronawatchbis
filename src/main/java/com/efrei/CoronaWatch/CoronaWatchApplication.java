...
public class CoronaWatchApplication {
	...
	public CommandLineRunner demo(ArticleRepository articlerepository ,
		...
		return (args) -> {
			...
			ContinentStatistics af = new ContinentStatistics(0,0,0,0,StatisticsTypes.Continent);
			...
			ContinentStatistics e = new ContinentStatistics(0,0,0,0,StatisticsTypes.Continent);
